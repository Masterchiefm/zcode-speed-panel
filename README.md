...
完整面板：当前速度 / 今日平均 / 今日总量三块仪表 + **网速监控**（整机速度、会话上传估算）+ 近 15 分钟速度曲线 + 状态栏（当前速度弧线随速度分档变色：0–40 绿 / 40–80 黄绿 / 80–160 黄 / 160–240 橙 / 240–320 红 / 320+ 品红；当前速度卡右上角另有"上轮"小圆环，显示最近一次已完成调用的速度）；**快照防护与上传记录**卡默认隐藏，可在顶栏 ⚙ 设置中开启
